...
//  PG_VOLTAGE_SENSOR_ADC_CONFIG
    ...
    { "vbat_offset",                VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { VBAT_OFFSET_MIN, VBAT_OFFSET_MAX }, PG_VOLTAGE_SENSOR_ADC_CONFIG, offsetof(voltageSensorADCConfig_t, vbatoffset) },
